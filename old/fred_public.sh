...
print_title "FRED-App, instalacion.  NIC CR"
print_title "=============================="
...
echo "$(timestamp) 1/9 Instalano pre-requitos del sistema operativo"
echo "=============================================================="

apt_install ca-certificates curl gnupg lsb-release

echo "$(timestamp) 2/9 Instalano dependencias de Python"
echo "=================================================="

apt_install python3-dnspython python3-pip uwsgi-plugin-python3 postgresql-client

echo "3/9. Creating CZ NIC keyring for FRED Packages"
echo "==============================================="
...
echo "4/9 Creating sources list fred.list"
...
echo "5/9 Installing FRED Postfix installation"
echo "========================================="
...
echo "6/9 Creating FRED APT PIN Files to install correct fred packages"
echo "================================================================="
